...
public class CategoryService {
    ...
    public List<CategoryDTO> getAllCategories(String username) {
        ...
        List<Category> categories = categoryRepository.findAllAvailableCategories(user); // Custom query needed or logic to combine
        // Actually, the requirement says "The system provides predefined categories... Users can create custom categories".
        // It implies a user sees both.
        // My repo method findAllAvailableCategories(user) handles this: (user is null OR user = :user)
    ...
    public void deleteCustomCategory(String username, String categoryName) {
        ...
        // Check if referenced by transactions (ToDo: Implement check once Transaction implemented)
        // For now, just delete
